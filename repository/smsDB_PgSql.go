...
type SMSDbSql struct {
	pool *pgxpool.Pool
}

var TAG_SMS = "Sheet Repository"

func NewSMSDbSql(pool *pgxpool.Pool) *SMSDbSql {
	return &SMSDbSql{
		pool: pool,
	}
}

func (r *SMSDbSql) Extracts(formId int8) ([]*entity.Responses, error) {
...
func (r *SMSDbSql) QuesIdExtracts(formId int8) ([]int, []string, error) {
